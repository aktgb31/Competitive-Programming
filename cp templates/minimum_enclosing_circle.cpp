/*
  Created by: Amit Kumar at 12:08 on 13 Feb 21
*/
#include <bits/stdc++.h>
#ifdef LOCAL
#include "debug.h"
...
void solve()
{
    ...
    Circle mec1 = welzl(px);
    Circle mec2 = welzl(py);
    Circle mec3 = welzl(pz);
    cout << setprecision(10) << fixed << double(2.0) * min(mec1.R, min(mec2.R, mec3.R)) << "\n";
}
int main()
{
#ifdef LOCAL
